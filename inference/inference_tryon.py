...
from inference_dataset import get_tryon_dataloader
#
import argparse
...
def inference(net, opts, use_gpu=True):
    ...
    inference_dataloader = get_tryon_dataloader('/opt/ohpc/wubowen/clothes_person', '/opt/ohpc/wubowen/clothes_person_parsing')
    sstime = time.time()
